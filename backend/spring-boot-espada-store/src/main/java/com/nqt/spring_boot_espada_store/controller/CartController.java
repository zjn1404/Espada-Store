...
public class CartController {
    ...
    @Operation(
            ...
            description = "API creates new cart if there's not existing cart and add product into it.")
    ...
    @GetMapping
    @Operation(
            summary = "Get all items in customer's cart",
            description = "API gets all items in logged in customer's cart.")
    ...
    @Operation(
            summary = "Update item's quantity in logged-in customer's cart",
            description = "API updates item's quantity in logged-in customer's cart.")
    ...
    @Operation(
            summary = "Delete item in logged-in customer's cart by ID and Size",
            description = "API deletes item in logged-in customer's cart by ID and Size.")
    public ApiResponse<Object> removeItemFromCart(
            @PathVariable(name = "productId") String productId, @PathVariable(name = "size") String size) {
    ...
    @Operation(
            summary = "Delete all items in logged-in customer's cart",
            description = "API deletes all items in logged-in customer's cart.")
