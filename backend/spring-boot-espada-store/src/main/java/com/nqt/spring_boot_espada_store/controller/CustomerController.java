...
public class CustomerController {
    ...
    @PostMapping
    @Operation(summary = "Create customer's information detail", description = "API creates customer's information detail.")
    ...
    @GetMapping
    @Operation(summary = "Get customer's information detail of logged-in user", description = "API gets customer's information detail of logged-in user.")
    ...
    @PutMapping
    @Operation(summary = "Update customer's information detail of logged-in user", description = "API updates customer's information detail of logged-in user.")
