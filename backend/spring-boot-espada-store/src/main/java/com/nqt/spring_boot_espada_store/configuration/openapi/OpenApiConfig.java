...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI(@Value("${open.api.title}") String title,
        ...
        description += String.format("<br>An admin account has been created with <b>username: %s</b> and <b>password: %s</b>.\nYou can use it to access all APIs.", username, password);
